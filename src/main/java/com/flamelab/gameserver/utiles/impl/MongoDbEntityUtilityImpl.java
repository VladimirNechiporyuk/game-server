...
public class MongoDbEntityUtilityImpl<E extends CommonEntity> implements DbEntityUtility<E> {
    ...
    @Override
    public E updateEntity(E entity, Class<E> entityClass, Map<FieldNames, Object> fieldsWithNewData, DbCollectionNames collectionName) {
        return null;
    }
    ...
    @Override
    public void deleteAllFromDbByIds(List<ObjectId> ids, Class<E> searchedClass, DbCollectionNames collectionName) {
...
//
//    public E findOneBy(Map<FieldNames, Object> criterias, Class<E> searchedClass, DbCollectionNames dbCollectionName) {
//        List<E> entitiesFoundFromDb = mongoTemplate.find(buildQuery(criterias), searchedClass, dbCollectionName.name());
...
//
////    public void deleteAllFromDbByIds(List<ObjectId> ids, Class<E> searchedClass, DbCollectionNames collectionName) {
////        Map<FieldNames, Object> criterias = new HashMap<>();
////        criterias.put(DELETED__FIELD_APPELLATION, false);
////        ids.forEach(id -> {
////            criterias.put(ID__FIELD_APPELLATION, id);
////            mongoTemplate.findAndRemove(buildQuery(criterias), searchedClass, collectionName.name());
////        });
////    }
//
//    public boolean isEntityExistsBy(Map<FieldNames, Object> criterias, Class<E> targetClass, DbCollectionNames dbCollectionName) {
